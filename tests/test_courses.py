...
def test_empty_courses_list(chromium_page_with_state):
    ...
    courses_empty_list_text = chromium_page_with_state.get_by_test_id("courses-list-empty-view-title-text")
    expect(courses_empty_list_text).to_be_visible()
    ...
    expect(courses_empty_list_description).to_have_text(
